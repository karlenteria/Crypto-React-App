...
const TableComponent = () => {
  ...
  return (
    <>
        <div 
    className='flex flex-col h-[80%]  mt-9 border border-primary rounded text-gray-300 overflow-auto'>
    {
        cryptoData ?  <table className='w-full table-auto '>
            <thead className='capitalize text-base text-gray-300 font-medium border-b border-gray-200'>
                <tr>
    ...
    <div className='flex items-center justify-between mt-4 capitalize h-[2rem] text-gray-300'>
    <span>Powered by <a className='text-primary' href="https://www.coingecko.com" rel="noreferrer" target={"_blank"}><img className='flex h-[2.0rem]' src={coinGecko} alt="coingecko logo"></img></a></span>
        <Pagination />
    </div>
    </>
    )
